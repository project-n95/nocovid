...
?>
    ...
    <form method="post" class="woocommerce-ResetPassword lost_reset_password">
        ...
        <p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first labeled-input-row labeled-input-row--equal-width labeled-input-row--wrap">
